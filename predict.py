...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        prompt: str = Input(
            ...
            default="masterpiece, best quality, 1girl, bag, upper body, street, bangs, bare shoulders, beret, black footwear, black headwear, brown eyes, brown hair, closed mouth, handbag, hat, holding, long hair, long sleeves, looking at viewer, off shoulder, shoes, skirt, sleeves past wrists, socks, solo, sweater, white legwear",
        ),
